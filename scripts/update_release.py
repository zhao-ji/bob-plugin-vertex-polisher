...
def update_appcast(version, desc):
    release_file = Path(f'release/vertex-polisher-{version}.bobplugin')
    ...
    version_info = {
        ...
        'desc': desc,
        'sha256': file_hash,
        'url': f'https://github.com/zhao-ji/bob-plugin-vertex-ai-polisher/releases/download/v{version}/{release_file.name}',
        'minBobVersion': '1.8.0'
    }
